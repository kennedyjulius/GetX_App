...
class _ContentPageState extends State<ContentPage> {
  ...
  final String recentJson = await DefaultAssetBundle.of(context).loadString("json/recent.json");
  setState(() {
    list = jsonDecode(recentJson);
  });

  final String detailJson = await DefaultAssetBundle.of(context).loadString("json/detail.json");
  setState(() {
